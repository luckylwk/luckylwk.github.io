...
styleNode.appendChild( document.createTextNode(' .axis text { font: 9px sans-serif; fill: #aaa; } ') );
styleNode.appendChild( document.createTextNode(' .axis path, .axis line { fill: none; stroke: #666; shape-rendering: crispEdges; } ') );
styleNode.appendChild( document.createTextNode(' .hexagon { fill: none; stroke: #000; stroke-width: .5px; } ') );
styleNode.appendChild( document.createTextNode(' .bar { fill: steelblue; shape-rendering: crispEdges; } ') );
...
function drawGraph(){
    ...
    d3.select("#div-hexbin-hist").html('');
